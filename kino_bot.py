...
# Обработчик команды для отображения доступных мест и покупки билетов
...
async def process_seat(message: types.Message, state: FSMContext):
    ...
    # Проверяем занятость выбранного места
